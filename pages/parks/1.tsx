        ...
        <div className="flex flex-row gap-10 w-full">
          <section className="w-2/3">
            ...
            <p className="pb-2">
              ...
              located in Southern California. It is the largest state park in
              the contiguous United States, covering over 600,000 acres of
            ...
            <p className="pb-2">
              The park is a paradise for hikers, with over 500 miles of dirt
              roads and miles of hiking trails that offer unparalleled
              opportunities to explore the wonders of the Colorado Desert.
              Visitors can also enjoy the park's sweeping vistas, washes, and
              numerous opportunities to spot wildlife such as iguanas,
              chuckwallas, and the red diamond rattlesnake.
            </p>
            <p className="pb-2">
              To get to Anza-Borrego Desert State Park, most visitors approach
              from the east via Highways S22, S2, or 78. Visitors coming from
              San Diego can also take Highways 79 and 78, which pass through the
            ...
            <ul className="pb-2 list-disc list-inside">
              <li className="pb-2">
                Borrego Palm Canyon (sites 53-89): This campground is located in
                a beautiful canyon setting and is suitable for tents, trailers,
                and RVs. Each campsite has a picnic table and fire ring, and
                there are restrooms and showers nearby.
              </li>
              <li className="pb-2">
                Borrego Palm Canyon (sites 1-52): This campground is also
                located in a beautiful canyon setting and is suitable for tents,
                trailers, and RVs. Each campsite has a picnic table and fire
                ring, and there are restrooms and showers nearby.
              </li>
              <li className="pb-2">
                Borrego Palm Canyon (sites 90-120): This campground is located
                in a beautiful canyon setting and is suitable for tents,
                trailers, and RVs. Each campsite has a picnic table and fire
                ring, and there are restrooms and showers nearby.
              </li>
              <li className="pb-2">
                Tamarisk Grove Campground: This campground is located in a
              ...
              <li className="pb-2">
                ...
                located in a beautiful canyon setting and are suitable for
                tents, trailers, and RVs. They include a large, sheltered picnic
                area with tables and barbecue grills, as well as access to
                nearby restrooms and showers. These campsites are suitable for
                groups of up to 25 people.
              </li>
              <li className="pb-2">
                Vern Whitaker Horse Camp: This campground is designed
                specifically for horse enthusiasts and is located in a wooded
                area of the park. It includes a staging area, hitching rails,
                and corrals, as well as access to nearby restrooms and showers.
                It is suitable for tents and trailers.
              </li>
            </ul>
          </section>
