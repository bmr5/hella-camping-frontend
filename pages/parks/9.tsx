      ...
      <div className="flex flex-col md:flex-row gap-10 w-full">
        <section className="w-2/3">
          ...
          <p className="pb-2">
            ...
            located along California's stunning Mendocino Coast. It is known for
            its rich array of habitats, including beach, bluff, headland, dune,
            forest, and wetland, all of which offer a wide variety of
            recreational opportunities.
          </p>
          <p className="pb-2">
            One of the park's most popular features is its tidepools, which are
            home to a variety of marine life, including seals that can be
          ...
          <p className="pb-2">
            In addition to its natural beauty, MacKerricher State Park is also a
            popular destination for outdoor enthusiasts. It offers miles of
            trails for hiking, jogging, and biking, as well as horseback riding
            trails for equestrians. Fishing is also popular in the park, with
            two fresh-water lakes stocked with trout.
          </p>
          <p className="pb-2">
            The park is wheelchair accessible and has a nature trail that is
            suitable for visitors with disabilities. Whether you are interested
            in nature, birdwatching, or simply enjoying the great outdoors,
          ...
          <ul className="pb-2 list-disc list-inside">
            <li className="pb-2">
              Cleone Group Area: This group camping area is located in a wooded
