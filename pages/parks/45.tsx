        ...
        <div className="flex flex-row gap-10 w-full">
          <section className="w-2/3">
            ...
            <p className="pb-2">
              ...
              animal life, including redwood, tan oak, madrone, chaparral, and
              an 80-foot waterfall that drops from granite cliffs into the
              ocean.
            </p>
            <p className="pb-2">
              The park is also home to a 1,680-acre underwater reserve, which
              protects a stunning array of marine life. With a special-use
              permit, experienced divers can explore the reserve and see seals,
              sea lions, and sea otters in the park's cove. Hikers can also
              enjoy the park's backcountry via several trail systems.
            </p>
            <p className="pb-2">
              There is no park kiosk at Julia Pfeiffer Burns State Park for fee
              collection, and campers must register at Pfeiffer Big Sur State
              Park or Big Sur Station. The park is also available for special
              events such as weddings and small celebrations, but interested
              parties must contact Special Events at BigSurEvents@parks.ca.gov
              for more information.
            </p>
            <p className="pb-2">
              Julia Pfeiffer Burns State Park currently has no campgrounds but
              many other state parks surround it, including Limekiln and
              Pfeiffer Big Sure State Park, which are some of the best
              campgrounds in california. Some features of the park:
            </p>
            ...
            <ul className="pb-2 list-disc list-inside">
              <li className="pb-2">
                ...
                over 170 sites, and there are also several private campgrounds
                in the area.
              </li>
              <li className="pb-2">
              ...
              <li className="pb-2">
                Hiking Trails: Julia Pfeiffer Burns State Park has several
                hiking trails that range in difficulty and length, offering
                something for hikers of all levels. The trails lead through the
                park's redwood forests, along the coastline, and to the 80-foot
                McWay Falls.
              </li>
              <li className="pb-2">
              ...
              <li className="pb-2">
                ...
                by a short hike from the parking lot. The beach is a popular
              ...
              <li className="pb-2">
                Parking: The park has a large parking lot near the entrance,
                with space for cars and RVs.
              </li>
              <li className="pb-2">
