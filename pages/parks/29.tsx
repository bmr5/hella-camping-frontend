      ...
      <div className="flex flex-col md:flex-row gap-10 w-full">
        <section className="w-2/3">
          ...
          <p className="pb-2">
            ...
            including oak woodlands, chaparral, grasslands, and wetlands. It is
            a popular destination for hikers, with over 100 miles of trails that
            range from easy to challenging, and there are also trails for biking
          ...
          <ul className="pb-2 list-disc list-inside">
            <li className="pb-2">
              ...
              campsites that are suitable for tent camping. These campsites are
              located in a wooded area of the park and include a large,
              sheltered picnic area with tables and barbecue grills, as well as
              access to nearby restrooms and showers. These campsites are
