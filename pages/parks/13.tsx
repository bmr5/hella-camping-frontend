    ...
    <div className="w-full px-10 pt-10 pb-5 min-h-[1000px]">
      ...
      <div className="flex flex-col md:flex-row gap-10 w-full">
        <section className="w-2/3">
          ...
          <p className="pb-2">
            Angel Island State Park is a unique and historic destination located
            in the midst of San Francisco Bay. The park offers breathtaking
            views of the city skyline, the Marin Headlands, and Mount Tamalpais.
            In addition to its natural beauty, the island has a rich history
          ...
          <p className="pb-2">
            From 1910 to 1940, the island was used as an immigration processing
            center, where thousands of immigrants were processed before entering
            the United States. During World War II, the island was used to
            detain Japanese and German prisoners of war, and it also served as a
            jumping-off point for American soldiers returning from the Pacific.
          </p>
          <p className="pb-2">
          ...
          <ul className="pb-2 list-disc list-inside">
            <li className="pb-2">
              Ayala Cove Group Picnic Area: This area offers a large, sheltered
              picnic area with tables and barbecue grills, as well as a small
              beach for swimming and water activities. It is suitable for groups
              of up to 50 people.
            </li>
            <li className="pb-2">
              Ridge (sites 4-6): These campsites are located on a ridge
              overlooking Ayala Cove and offer stunning views of the San
              Francisco Bay. Each site has a picnic table, fire ring, and access
            ...
            <li className="pb-2">
              ...
              people. It includes a large, sheltered picnic area with tables and
              barbecue grills, as well as access to restrooms and drinking
              water.
            </li>
            <li className="pb-2">
              ...
              small RVs. Each site has a picnic table, fire ring, and access to
              nearby restrooms and drinking water. The Kayak site is
              specifically designed for campers who are arriving by kayak and
              includes a small boat launch.
            </li>
            <li className="pb-2">
              Sunrise (sites 7-9): These campsites are located in a sunny, open
              area of the park and offer excellent views of the surrounding
              area. Each site has a picnic table, fire ring, and access to
            ...
            <li className="pb-2">
              ...
              experience. Each site has a picnic table, fire ring, and access to
              nearby restrooms and drinking water.
            </li>
            <li className="pb-2">
              East Group Garrison Picnic Area: This large, sheltered picnic area
              is suitable for groups of up to 50 people and includes tables and
