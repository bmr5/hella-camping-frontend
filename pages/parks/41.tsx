      ...
      <div className="flex flex-col md:flex-row gap-10 w-full">
        <section className="w-2/3">
          ...
          <p className="pb-2">
            ...
            options, including Big Basin Tent Cabins, which provide convenience
            and comfort in a stunning outdoor setting.
          </p>
          <p className="pb-2">
          ...
          <p className="pb-2">
            ...
            cooler. The package also includes one bundle of wood and one bag of
            ice per night (up to two of each per reservation). This package is
            available for a small additional fee and can be reserved online. It
            is available for cabins #8, #9, #20, #28, and #29.
          </p>
          <p className="pb-2">
            For an even more luxurious experience, the park also offers Deluxe
            Cabins, which come with beds made up for your arrival (with sheets,
            towels, blankets, comforter, and pillows), curtains, lantern, bath
            towels, and washcloths. These cabins are available online and are
            offered for a small additional fee. They are available for cabins
            #6, #7, #10, #12, #13, #14, #30, and #31.
          </p>
          ...
          <ul className="pb-2 list-disc list-inside">
            <li className="pb-2">
              The Huckleberry Tent Cabins at Big Basin Redwoods State Park offer
              a unique and comfortable camping experience in the midst of
              California's stunning redwood forests. Each cabin features a
              raised platform with a mattress pad, a table, and a lockable door
              for added security and privacy. The cabins also have a picnic
              table and a fire ring outside, providing the perfect spot for a
              scenic outdoor meal or a cozy campfire. The cabins are located in
              a wooded area of the park and are suitable for tents or small RVs.
              They are conveniently located near restrooms and drinking water,
              and they offer easy access to the park's many trails and
              attractions. Whether you are looking for a comfortable base camp
              for your adventures in the Santa Cruz Mountains or just a peaceful
              retreat from the hustle and bustle of everyday life, the
              Huckleberry Tent Cabins at Big Basin Redwoods State Park are an
              excellent choice.
            </li>
          </ul>
        </section>
