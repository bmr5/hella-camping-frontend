        ...
        <div className="flex flex-row gap-10 w-full">
          <section className="w-2/3">
            ...
            <p className="pb-2">
              ...
              park that covers over 18,000 acres and is home to a wide variety
              of plant and animal life.
            </p>
            <p className="pb-2">
              The park features miles of trails that are suitable for hikers and
              equestrians, and the Skyline to the Sea Trail runs through the
              park, linking it to Castle Rock State Park and the eastern Santa
              Cruz range. The park also has a number of waterfalls, as well as a
              wide range of environments, including lush canyon bottoms,
              chaparral-covered slopes, and stately redwood groves.
            </p>
            <p className="pb-2">
              In addition to its stunning natural beauty, Big Basin Redwoods
              State Park is home to many animals, including deer, raccoons, and
              bobcats. The park is also a haven for birdwatchers, with a wide
              variety of bird species, including Steller's jays, egrets, herons,
              and California woodpeckers.
            </p>
            <p className="pb-2">
            ...
            <ul className="pb-2 list-disc list-inside">
              <li className="pb-2">
                Sequoia Group 1 & 2: These group campsites are suitable for
              ...
              <li className="pb-2">
                Upper Blooms Creek (sites 139-156): This campground is located
                in a scenic, wooded area of the park and is suitable for tents
                or small RVs. Each campsite has a picnic table, fire ring, and
                access to nearby restrooms and drinking water.
              </li>
              <li className="pb-2">
                Wastahi Campground (sites 76-102): This campground is located in
                a wooded area of the park and is suitable for tents or small
                RVs. Each campsite has a picnic table, fire ring, and access to
                nearby restrooms and drinking water.
              </li>
              <li className="pb-2">
                Lower Blooms Creek (sites 103-138): This campground is located
                in a wooded area of the park and is suitable for tents or small
                RVs. Each campsite has a picnic table, fire ring, and access to
                nearby restrooms and drinking water.
              </li>
              ...
              <li className="pb-2">
                ...
                located in a wooded area of the park and is suitable for tents
                or small RVs. Each campsite has a picnic table, fire ring, and
                access to nearby restrooms and drinking water.
              </li>
            </ul>
