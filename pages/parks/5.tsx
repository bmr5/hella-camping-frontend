    ...
    <div className="w-full px-10 pt-10 pb-5 min-h-[1000px]">
      ...
      <div className="flex flex-col md:flex-row gap-10 w-full">
        <section className="w-2/3">
          ...
          <p className="pb-2">
            Clear Lake State Park is a beautiful and serene destination located
            in the heart of California's Clear Lake region. The park is home to
            a variety of outdoor activities, including hiking, biking, fishing,
            and boating. Visitors can take in stunning views of Clear Lake,
            which is the largest natural freshwater lake in California, from the
            park's many overlooks and trails.
          </p>
          <p className="pb-2">
            The park is also home to a diverse array of plant and animal life,
            including oak woodlands, meadows, and wetlands. Visitors may spot a
            variety of bird species, including herons, egrets, and ospreys, as
            well as mammals like mule deer and coyotes.
          </p>
          <p className="pb-2">
            ...
            adventure-filled day in nature, Clear Lake State Park has something
          ...
          <ul className="pb-2 list-disc list-inside">
            ...
            <li className="pb-2">
              ...
              Park offers a more secluded camping experience for larger groups.
              The area has two group campsites that can accommodate up to 50
              people each, and each site is equipped with a picnic table, fire
              ring, and a grill. Restrooms with flush toilets and hot showers
              are also available.
            </li>
            <li className="pb-2">
              Lower Bay View Campground: The Lower Bay View Campground offers
              112 campsites with picturesque views of Clear Lake. The campsites
              are equipped with a picnic table, fire ring, and a grill, and the
              campground has restrooms with flush toilets and hot showers.
            </li>
            <li className="pb-2">
              Upper Bay View Campground: The Upper Bay View Campground has 147
              campsites with breathtaking views of Clear Lake. The campsites are
              equipped with a picnic table, fire ring, and a grill, and the
              campground has restrooms with flush toilets and hot showers.
            </li>
          </ul>
