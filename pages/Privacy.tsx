...
function Privacy() {
  return (
    <FooterPageLayouts>
      ...
      HellaCamping takes your privacy seriously. To better protect your privacy
      we provide this privacy policy notice explaining the way your personal
      information is collected and used.
      <h2 className="font-bold">Collection of Routine Information</h2>
      ...
      personally identify specific visitors to this website. The information is
      ...
      not responsible for the privacy policies on these websites. You should be
      aware that the privacy policies of these websites may differ from our own.
      ...
      This Privacy Policy is effective as of Jan 1st, 2023 and will remain in
      ...
      you should check this Privacy Policy periodically. If we make any material
      changes to this Privacy Policy, we will notify you either through the
      email address you have provided us, or by placing a prominent notice on
      our website.
      <h2 className="font-bold">Contact Information</h2>
      For any questions or concerns regarding the privacy policy, please send us
      an email to hello@hellacamping.com.
    </FooterPageLayouts>
  );
}
