      ...
      <div className=" max-w-7xl">
        ...
        <div className="flex flex-row gap-10 w-full">
          <section className="w-2/3">
            ...
            <p className="pb-2">
              San Clemente State Beach is a popular and scenic destination
              located in the beautiful Southern California coastline. It is
              known for its excellent surf on the north end of the beach and its
              hiking trails on the bluffs, which offer breathtaking views of the
              Pacific Ocean.
            </p>
            <p className="pb-2">
              The beach itself is a mile long and is popular for body surfing,
              swimming, and skin diving. It is also home to a landscaped
              blufftop with picnic areas, providing the perfect spot for a
              scenic outdoor meal.
            </p>
            <p className="pb-2">
              San Clemente State Beach offers a variety of accommodation
              options, including campsites for tents and RVs. Each campsite
              includes parking for one car and a towed vehicle, with additional
              vehicles charged at $15 per day per vehicle. The beach also has
              several amenities, including restrooms, showers, and a snack bar.
            </p>
            <p className="pb-2">
            ...
            <ul className="pb-2 list-disc list-inside">
              ...
              <li className="pb-2">
                Tent Campground East Section (sites 100-160): This section of
                the campground is also suitable for tents and is located in a
                wooded area of the park. Each campsite has a picnic table and
                fire ring, and there are restrooms and showers nearby.
              </li>
              <li className="pb-2">
                RV Campground (sites 1-72): This section of the campground is
                suitable for RVs and is located in a wooded area of the park.
                Each campsite has a picnic table and fire ring, and there are
                restrooms and showers nearby.
              </li>
              <li className="pb-2">
                Tent Group Camp: This group campsite is suitable for tents and
                is located in a wooded area of the park. It includes a large,
